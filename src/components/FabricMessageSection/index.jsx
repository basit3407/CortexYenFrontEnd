  ...
  return (
    <div className="fashion-text-container">
      <div className="global-fashion-styles-container">
        ...
        <p className="global-fashion-text-snippet">{messages["lrem_ipsum_suledes_plankning_till_heterossade_tosn"]}</p>
      </div>
    </div>
  );
}

export default FabricMessageSection;
